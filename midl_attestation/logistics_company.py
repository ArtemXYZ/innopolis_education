...
class Delivery(ServiceTols):
    ...
    def __init__(
        ...
        super().__init__()
        self.delivery_id = delivery_id if self.validator(delivery_id, int | None) else ...
        self.from_point = from_point if self.validator(from_point, str | None) else ...
        self.to_point = to_point if self.validator(to_point, str | None) else ...
        self.weight_cargo = weight_cargo if self.validator(weight_cargo, float | int | None) else ...
        self.time_delivery = time_delivery if self.validator(time_delivery, int | None) else ...
        self.task_name = task_name if self.validator(task_name, str | None) else ...
        self.priority = priority if self.validator(priority, int | None) else ...
...
class LogisticsMachine(Delivery, ServiceTols, AlgorithmsForeInstanceClasses):
    ...
    def search_delivery_elem_by_delivery_id(self, _delivery_id: int):
        ...
        self.validator(_delivery_id, int)
    ...
    def search_delivery_elem_by_time_delivery(self, _time_delivery: int):
        ...
        self.validator(_time_delivery, int)
